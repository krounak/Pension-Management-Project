...
/**
 * Authorization Controller to handle the requests for logging  a valid user and for
...
public class AuthorizationController {
	 ...
	 * @return method for token on successful login else throws exception handled by
	...
	/**
	 * @URL: http://localhost:8081/api/auth/statusCheck
