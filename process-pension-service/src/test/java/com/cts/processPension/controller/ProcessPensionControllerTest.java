...
class ProcessPensionControllerTest {
	...
	void setup() throws ParseException {
		...
		validPensionerInput = new PensionerInput("Asha", DateUtil.parseDate("16-02-1999"), "ABCDE12345",
				"300546467895", "self");

		// invalid PensionerInput
		invalidPensionerInput = new PensionerInput("Asha", DateUtil.parseDate("16-02-1999"), "ABCDE12345", "",
				"self");

		// correct PensionDetails
		pensionDetail = new PensionDetail("Asha", DateUtil.parseDate("16-02-1999"), "ABCDE12345", "family", 50000);
