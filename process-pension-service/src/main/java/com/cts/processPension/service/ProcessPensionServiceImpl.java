...
public class ProcessPensionServiceImpl implements IProcessPensionService {
	...
	@Autowired
	private PensionDetailRepository pensionDRepository;
	...
	public PensionDetail calculatePensionAmount(PensionerDetail pensionDetail) {
		...
		PensionDetail pensionD = new PensionDetail(pensionDetail.getName(), pensionDetail.getDateOfBirth(), pensionDetail.getPan(),
				pensionDetail.getPensionType(), pensionAmount);
		
		pensionDRepository.save(pensionD);
